...
<div class="main-wrapper">
    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center">
        <div class="auth-box bg-dark border-top border-secondary" style="    background: transparent !important;
    box-shadow: 0px 9px 12px 4px #ccc;">
            <div id="loginform">
                <div class="text-center p-t-20 p-b-20">
                    <span class="db"><img src="{{asset('taxkamkar/assets/images/logo.png')}}" alt="logo" /></span>
                </div>
                <!-- Form -->
    ...
    border: none;" class="btn btn-info" id="to-recover" type="button"><i class="fa fa-lock m-r-5"></i> Lost password?</button>
