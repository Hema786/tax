...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Prospect Users</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">All prospects</li>
                    </ol>
                </div>
                <!-- /.col -->
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Prospects users</h3>
                        </div>
                        <!-- /.card-header -->
                        <?php
                            $query_reg_users = "SELECT * FROM `users` WHERE role = 5";
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        */ ?>
                                        ...
                                        <td>
                                            <a href="edit_prospect.php?id=<?= $row['id'] ?>">
                                                <span>
                                        ...
                                        <td>
                                            <a href="control/controller.php?action=delete_prospect&id=<?= $row['id'] ?>">
                                                <span>
