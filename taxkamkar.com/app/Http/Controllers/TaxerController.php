...
class TaxerController extends Controller
{
    /**
...
//        $users = User::all();
        return view('admin.taxer.index',compact('taxes'));
    }
    ...
    public function create()
    {
        ...
        $users = User::all();
        return view('admin.taxer.create',compact('users'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.taxer.edit',compact('salary'));
    }
